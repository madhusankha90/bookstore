...
const Order = ({match, history}) => {
    ...
    return (
        <div className='order-page'>
            <Meta title="Your Order | bookstorelk" />
            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={4}>
                    ...
                    <Card>
                        ...
                        <h3>ORDER SUMMARY</h3>
                        <Divider/>
                        <SummaryItem>Items:  <strong>LKR {order.orderItems.reduce( (acc,item) => acc + item.price * item.qty , 0).toFixed(2)}</strong>
                        </SummaryItem>
                        <SummaryItem>Shipping:  <strong>LKR {order.shippingPrice}</strong></SummaryItem>
                        <SummaryItem>Total:  <strong>LKR{order.totalPrice}</strong></SummaryItem>
                        <ShippingMessage>(Orders above LKR 100 have free shipping)</ShippingMessage>
                        </CardContent>
