            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={4}>
                    ...
                    <Card>
                        ...
                        <h3>ORDER SUMMARY</h3>
                        <Divider/>
                        <SummaryItem>Items:  <strong>LKR {cart.itemsPrice}</strong></SummaryItem>
                        <SummaryItem>Shipping:  <strong>LKR {cart.shippingPrice}</strong></SummaryItem>
                        <SummaryItem>Total:  <strong>LKR {cart.totalPrice}</strong></SummaryItem>
